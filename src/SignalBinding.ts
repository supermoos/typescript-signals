 ...
 *
 *	@version	1.1 - 27th September 2017
 *
 *	@author 	Lasse Moos, Fixed some typing errors
...
export class SignalBinding {
     ...
     */
    constructor(signal:Signal, listener:Function, isOnce:boolean, listenerContext:Object, priority:number = 0) {
